...
" MODES SUPPORT
" NORMAL MODE ---------------------------------------------------------------{{{
let s:N1 = [ s:guiOrange     , s:guiGray , s:ctermWhite     , s:ctermGray ]
let s:N2 = [ s:guiLightgray  , s:guiGray , s:ctermLightgray , s:ctermGray  ]
let s:N3 = [ s:guiOrange     , s:guiGray , s:ctermLightgray , s:ctermGray ]
...
let s:V2 = [ s:guiBlack , s:guiGray , s:ctermLightgray , s:ctermGray  ]
...
let s:R2 = [ s:guiBlack  , s:guiGray , s:ctermLightgray  , s:ctermGray ]
